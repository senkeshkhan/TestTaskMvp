...
package empolyesecurity.testtaskmvp.data.dp;
...
public class AppDbHelper implements DbHelper {
    ...
    @Override
    public Observable<Boolean> insertBlog(final List<Blog> blogList) {
        return Observable.fromCallable(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                mDaoSession.getBlogDao().insertOrReplaceInTx(blogList);
                System.out.println("blogListblogList"+blogList);
    ...
    public Observable<List<Blog>> getAllBlog() {
        return Observable.fromCallable(new Callable<List<Blog>>() {
            ...
            public List<Blog> call() throws Exception {
                return mDaoSession.getBlogDao().loadAll();
            }
        });
    }
  @Override
    ...
    public Observable<Boolean> saveOptionList(final List<Option> optionList) {
        return Observable.fromCallable(new Callable<Boolean>() {
            ...
            public Boolean call() throws Exception {
                ...
                mDaoSession.getOptionDao().deleteInTx(optionList);
                return true;
            }
        });
    }
