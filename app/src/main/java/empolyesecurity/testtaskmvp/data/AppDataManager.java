...
package empolyesecurity.testtaskmvp.data;
...
import empolyesecurity.testtaskmvp.data.dp.model.Option;
import empolyesecurity.testtaskmvp.data.dp.model.Question;
import empolyesecurity.testtaskmvp.data.dp.model.User;
...
import empolyesecurity.testtaskmvp.data.network.model.LogoutResponse;
import empolyesecurity.testtaskmvp.data.network.model.OpenSourceResponse;
...
public class AppDataManager implements DataManager {
   ...
   private final DbHelper mDbHelper;
    ...
    @Inject
    public AppDataManager(@ApplicationContext Context context , DbHelper dbHelper, PreferencesHelper preferencesHelper, APIService apiService) {
        mContext = context;
        mDbHelper = dbHelper;
...
/*
  ...
  /*  @Override
    public Observable<BlogResponse> getForecastForCity(){
        ...
        return mApiHelper.getForecastForCity();
    }*/
}
